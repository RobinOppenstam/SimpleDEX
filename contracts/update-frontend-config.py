...
def main():
    ...
    print(f"{Colors.BLUE}[1/4] Updating tokens.ts{Colors.NC}")
    update_tokens_config(env_vars, frontend_dir)

    print(f"{Colors.BLUE}[2/4] Updating priceFeeds.ts{Colors.NC}")
    update_pricefeeds_config(env_vars, frontend_dir)

    print(f"{Colors.BLUE}[3/4] Updating page.tsx{Colors.NC}")
    update_page_config(env_vars, frontend_dir)

    print(f"{Colors.BLUE}[4/4] Updating deprecated config/tokens.ts{Colors.NC}")
    ...
    print("  2. The frontend will automatically use the new addresses")
    print()
